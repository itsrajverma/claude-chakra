...
def test_create_app_writes_server_log_under_chakra_home(monkeypatch, tmp_path):
    """App logging uses ~/.chakra/logs/server.log regardless of cwd."""
    ...
    assert canonical_log == tmp_path / ".chakra" / "logs" / "server.log"
