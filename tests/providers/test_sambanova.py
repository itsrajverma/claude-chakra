"""Tests for the SambaNova provider (OpenAI-compatible, free tier)."""
...
def test_build_request_body_basic(sambanova_config):
    provider = SambaNovaProvider(sambanova_config)
